...
export default function HeroSection() {
      ...
      <>
        ...
        <Head>
          <link
            rel="preload"
            as="image"
            href="/images/taichi-portfolio-top.png"
  ...
  // 使用する画像を決定
  const imageProps =
    useDefault || !heroImage
      ? {
          // デフォルト画像
          src: "/images/taichi-portfolio-top.png",
    ...
    <>
      ...
      <Head>
        <link
          ...
          crossOrigin="anonymous"
        />
        <link rel="prefetch" href={imageProps.src} crossOrigin="anonymous" />
      </Head>
